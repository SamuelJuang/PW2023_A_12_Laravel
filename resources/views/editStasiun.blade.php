...
<body>
    ...
    <div class="container ">
        ...
        <div>
            <p class="text-white fw-bold fs-5 mb-5" style="margin-left: 10px;">Edit Stasiun</p>
        </div>
    </div>
        ...
        <from class="editTiketContainer" action="">
            <div class="d-flex">
                <div style="margin-left: 15%;">
                    <label class="form-label" for="username">Nama Stasiun</label>
