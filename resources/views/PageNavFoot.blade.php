        ...
        <img src="{{asset('images/SAF Logo.svg')}}" alt="SAF logo"class="navbar-brand" style="height: 7vh;">
          <div class="d-flex justify-content-end px-3 py-2">
            @auth
               ...
               <img src="{{ asset('images/' . auth()->user()->profilePic)}}" alt="ProfilePic" height="40" width="40" onclick="ProfileRedirect()" class="rounded-circle border border-light bisaDipencet">
               @else
               <a href="{{ url('/profile') }}">
